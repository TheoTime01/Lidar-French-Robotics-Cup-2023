            ...
            if taille > 1:
                ...
                if new_value['angle']:
                    for index in range(0, len(new_value['angle'])):
                        ...
                        buf[a] = d
                        #if the value of angle is between 1 and 90, add Front right in the line
                        if a>=1 and a<=90 and d<30 :
                            print("Robot dangereux vers Avant Droite")

                        #if the value of angle is between 91 and 180, add Front left in the line
                        elif a>=91 and a<=180 and d<30 :
                            print("Robot dangereux vers Avant Gauche")

                        #if the value of angle is between 181 and 270, add Back left in the line
                        elif a>=181 and a<=270 and d<30 :
                            print("Robot dangereux vers Arrière Gauche")

                        #if the value of angle is between 271 and 360, add Back right in the line
                        elif a>=271 and a<=360 and d<30:
                            print("Robot dangereux vers Arrière Droite")

                        elif previous > a and previous > 300 and size > 400:
